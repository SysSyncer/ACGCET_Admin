...
{
    public partial class DeleteConvertMarkViewModel : ObservableObject
    {
        ...
        public DeleteConvertMarkViewModel(AcgcetDbContext dbContext)
        {
            _dbContext = dbContext;
            _ = LoadSessionsAsync();
        }

        public DeleteConvertMarkViewModel() { _dbContext = null!; }
        ...
        private async Task LoadResults(int studentId)
        {
            ...
            foreach(var r in results)
            {
                ResultList.Add(new DeleteResultItem
                {
                    ...
                    Result = r.Grade ?? "", // Showing Grade as result
        ...
        private async Task Delete()
        {
            ...
            if (MessageBox.Show($"Delete {selected.Count} results?", "Confirm", MessageBoxButton.YesNo) == MessageBoxResult.Yes)
            {
    ...
    public partial class DeleteResultItem : ObservableObject
    {
